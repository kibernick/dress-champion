...
def test_get_or_create_obj_present(dress, dress_uid):
    _dress = Dress.get_or_create('uid', dress_uid)

    assert _dress.uid == dress_uid


def test_get_or_create_obj_not_present(db, dress_uid):
    _dress = Dress.get_or_create('uid', dress_uid)

    assert _dress.uid == dress_uid


def test_get_or_create_obj_not_present_race_condition(db, dress_uid, dress):
